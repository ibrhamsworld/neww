        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Why Leading Paint Manufacturers Choose Us
            </h2>
          </div>
          {/* Central Image/Icon */}
          <div className="pb-16 md:pb-20" data-aos="zoom-y-out">
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,var(--color-blue-500),transparent)]">
                <div className="flex h-[400px] w-[400px] items-center justify-center rounded-full bg-gray-900">
                  <svg
                    className="h-48 w-48 fill-blue-500"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  >
                    <path d="M19.5 3h-15A1.5 1.5 0 0 0 3 4.5v15A1.5 1.5 0 0 0 4.5 21h15a1.5 1.5 0 0 0 1.5-1.5v-15A1.5 1.5 0 0 0 19.5 3zM6 6h3v3H6V6zm0 5h3v3H6v-3zm0 5h3v3H6v-3zm5-10h7v2h-7V6zm0 4h7v2h-7v-2zm0 4h7v2h-7v-2zm0 4h4v2h-4v-2z" />
                  </svg>
                </div>
                <div className="pointer-events-none" aria-hidden="true">
                  ...
                  <div>
                    <div className="absolute -left-28 top-16 z-10 animate-[float_4s_ease-in-out_infinite_both] opacity-80 transition-opacity duration-500">
                      <div className="rounded-full bg-blue-900/90 px-4 py-2 text-sm font-medium text-white shadow-lg backdrop-blur-sm">
                        ISO Certified
                      </div>
                    </div>
                    <div className="absolute left-56 top-7 z-10 animate-[float_4s_ease-in-out_infinite_1s_both] opacity-70 transition-opacity duration-500">
                      <div className="rounded-full bg-blue-900/90 px-4 py-2 text-sm font-medium text-white shadow-lg backdrop-blur-sm">
                        Global Supply
                      </div>
                    </div>
                    <div className="absolute -left-20 bottom-24 z-10 animate-[float_4s_ease-in-out_infinite_2s_both] opacity-60 transition-opacity duration-500">
                      <div className="rounded-full bg-blue-900/90 px-4 py-2 text-sm font-medium text-white shadow-lg backdrop-blur-sm">
                        Quality Tested
                      </div>
                    </div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Every batch is rigorously tested to meet international standards. We provide comprehensive COA (Certificate of Analysis) with each shipment to ensure consistency and quality.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                From titanium dioxide and resins to specialty pigments and additives, we stock a comprehensive range of raw materials for all paint formulations.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Available in various packaging options from small containers to bulk tankers. We accommodate orders of all sizes to meet your production needs.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Efficient supply chain management ensures timely delivery. With strategic warehouse locations, we minimize lead times and keep your production running smoothly.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Strong relationships with leading manufacturers worldwide allow us to source premium materials at competitive prices and ensure consistent supply.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Our experienced team provides formulation assistance and technical guidance to help you optimize your paint products and solve production challenges.
              </p>
            </article>
          </div>
        </div>
